...
proc sgscatter data=fitness;
    matrix age weight oxy runtime rstpulse runpulse maxpulse;
run;

/*---------------------------------------------------------
  Correlation Matrix + Scatterplot Matrix + Histograms
---------------------------------------------------------*/
...
/*---------------------------------------------------------
  Optional: Cleaner correlation table (Pearson only)
---------------------------------------------------------*/
